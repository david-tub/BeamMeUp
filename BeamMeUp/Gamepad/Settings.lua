...
function CS.SetupOptionsMenu(index) --index == Addon name
    ...
    local optionsData = {
         ...
         {
              type = LHAS.ST_CHECKBOX,
              label = BMU_SI_get(SI_TELE_SETTINGS_HIDE_ON_MAP_CLOSE),
              tooltip = BMU_SI_get(SI_TELE_SETTINGS_HIDE_ON_MAP_CLOSE_TOOLTIP) .. " [DEFAULT: " .. tostring(BMU_DefaultsAccount["HideOnMapClose"]) .. "]",
		 ...
		 {
              type = LHAS.ST_CHECKBOX,
              label = BMU_SI_get(SI_TELE_SETTINGS_CLOSE_ON_PORTING),
              tooltip = BMU_SI_get(SI_TELE_SETTINGS_CLOSE_ON_PORTING_TOOLTIP) .. " [DEFAULT: " .. tostring(BMU_DefaultsAccount["closeOnPorting"]) .. "]",
		 ...
		 {
              type = LHAS.ST_CHECKBOX,
              label = BMU_SI_get(SI_TELE_SETTINGS_WINDOW_STAY),
              tooltip = BMU_SI_get(SI_TELE_SETTINGS_WINDOW_STAY_TOOLTIP) .. " [DEFAULT: " .. tostring(BMU_DefaultsAccount["windowStay"]) .. "]",
		 ...
		 {
              type = LHAS.ST_CHECKBOX,
              label = BMU_SI_get(SI_TELE_SETTINGS_FOCUS_ON_MAP_OPEN),
              tooltip = BMU_SI_get(SI_TELE_SETTINGS_FOCUS_ON_MAP_OPEN_TOOLTIP) .. " [DEFAULT: " .. tostring(BMU_DefaultsAccount["focusZoneSearchOnOpening"]) .. "]",
		 ...
		 {
              type = LHAS.ST_SLIDER,
              label = BMU_SI_get(SI_TELE_SETTINGS_AUTO_PORT_FREQ),
              tooltip = BMU_SI_get(SI_TELE_SETTINGS_AUTO_PORT_FREQ_TOOLTIP) .. " [DEFAULT: " .. BMU_DefaultsAccount["AutoPortFreq"] .. "]",
              min = 50,
              max = 500,
		 ...
		 {
              type = LHAS.ST_SLIDER,
              label = BMU_SI_get(SI_TELE_SETTINGS_CHAT_BUTTON_OFFSET),
              tooltip = BMU_SI_get(SI_TELE_SETTINGS_CHAT_BUTTON_OFFSET_TOOLTIP) .. " [DEFAULT: " .. BMU_DefaultsAccount["chatButtonHorizontalOffset"] .. "]",
              min = 0,
              max = 200,
		 ...
		 {
              type = LHAS.ST_SLIDER,
              label = BMU_SI_get(SI_TELE_SETTINGS_MAP_DOCK_OFFSET_HORIZONTAL),
              tooltip = BMU_SI_get(SI_TELE_SETTINGS_MAP_DOCK_OFFSET_HORIZONTAL_TOOLTIP) .. " [DEFAULT: " .. BMU_DefaultsAccount["anchorMapOffset_x"] .. "]",
			        min = -100,
              max = 100,
		 ...
		 {
              type = LHAS.ST_SLIDER,
              label = BMU_SI_get(SI_TELE_SETTINGS_MAP_DOCK_OFFSET_VERTICAL),
			  tooltip = BMU_SI_get(SI_TELE_SETTINGS_MAP_DOCK_OFFSET_VERTICAL_TOOLTIP) .. " [DEFAULT: " .. BMU_DefaultsAccount["anchorMapOffset_y"] .. "]",
			  min = -150,
			  max = 150,
		 ...
		 {
              type = LHAS.ST_CHECKBOX,
              label = BMU_SI_get(SI_TELE_SETTINGS_AUTO_REFRESH),
              tooltip = BMU_SI_get(SI_TELE_SETTINGS_AUTO_REFRESH_TOOLTIP) .. " [DEFAULT: " .. tostring(BMU_DefaultsAccount["autoRefresh"]) .. "]",
        ...
        label = BMU_SI_get(SI_TELE_SETTINGS_SORTING),
        tooltip = BMU_SI_get(SI_TELE_SETTINGS_SORTING_TOOLTIP) .. " [DEFAULT: " .. BMU.dropdownSortChoices[BMU.DefaultsCharacter["sorting"]] .. "]",
			  items = dropdownSortItems,
        getFunction = function() return BMU.dropdownSortChoices[BMU_savedVarsChar.sorting] end,
			  setFunction = function(control, itemName, itemData)
			    BMU_savedVarsChar.sorting = itemData.data
        end,
			  default = BMU.dropdownSortChoices[BMU.DefaultsCharacter["sorting"]],
        },
-- 		{
-- 			type = LHAS.ST_DROPDOWN,
-- 			label = BMU_SI_get(SI_TELE_SETTINGS_DEFAULT_TAB),
-- 			tooltip = BMU_SI_get(SI_TELE_SETTINGS_DEFAULT_TAB_TOOLTIP) .. " [DEFAULT: " .. BMU.dropdownDefaultTabChoices[BMU.DefaultsCharacter["defaultTab"]] .. "]",
-- 			items = dropdownDefaultTabItems,
-- 			getFunction = function() return BMU.dropdownDefaultTabChoices[BMU_savedVarsChar.defaultTab]  end,
-- 			setFunction = function(control, itemName, itemData) BMU_savedVarsChar.defaultTab = itemData.data end,
-- 			default = BMU.dropdownDefaultTabChoices[BMU.DefaultsCharacter["defaultTab"]],
-- 			disabled = function() return not BMU_savedVarsAcc.autoRefresh end,
-- 		 },
         {
              type = LHAS.ST_CHECKBOX,
              label = BMU_SI_get(SI_TELE_SETTINGS_SHOW_NUMBER_PLAYERS),
              tooltip = BMU_SI_get(SI_TELE_SETTINGS_SHOW_NUMBER_PLAYERS_TOOLTIP) .. " [DEFAULT: " .. tostring(BMU_DefaultsAccount["showNumberPlayers"]) .. "]",
         ...
         {
              type = LHAS.ST_CHECKBOX,
              label = BMU_SI_get(SI_TELE_SETTINGS_SEARCH_CHARACTERNAMES),
              tooltip = BMU_SI_get(SI_TELE_SETTINGS_SEARCH_CHARACTERNAMES_TOOLTIP) .. " [DEFAULT: " .. tostring(BMU_DefaultsAccount["searchCharacterNames"]) .. "]",
         ...
         {
              type = LHAS.ST_CHECKBOX,
              label = BMU_SI_get(SI_TELE_SETTINGS_ZONE_ONCE_ONLY),
              tooltip = BMU_SI_get(SI_TELE_SETTINGS_ZONE_ONCE_ONLY_TOOLTIP) .. " [DEFAULT: " .. tostring(BMU_DefaultsAccount["zoneOnceOnly"]) .. "]",
		 ...
		 {
              type = LHAS.ST_CHECKBOX,
              label = BMU_SI_get(SI_TELE_SETTINGS_CURRENT_ZONE_ALWAYS_TOP),
              tooltip = BMU_SI_get(SI_TELE_SETTINGS_CURRENT_ZONE_ALWAYS_TOP_TOOLTIP) .. " [DEFAULT: " .. tostring(BMU_DefaultsAccount["currentZoneAlwaysTop"]) .. "]",
		 ...
		 {
              type = LHAS.ST_CHECKBOX,
              label = BMU_SI_get(SI_TELE_SETTINGS_VIEWED_ZONE_ALWAYS_TOP),
              tooltip = BMU_SI_get(SI_TELE_SETTINGS_VIEWED_ZONE_ALWAYS_TOP_TOOLTIP) .. " [DEFAULT: " .. tostring(BMU_DefaultsAccount["currentViewedZoneAlwaysTop"]) .. "]",
		 ...
		 {
              type = LHAS.ST_CHECKBOX,
              label = BMU_SI_get(SI_TELE_SETTINGS_FORMAT_ZONE_NAME),
              tooltip = BMU_SI_get(SI_TELE_SETTINGS_FORMAT_ZONE_NAME_TOOLTIP) .. " [DEFAULT: " .. tostring(BMU_DefaultsAccount["formatZoneName"]) .. "]",
		 ...
		 {
              type = LHAS.ST_SLIDER,
              label = BMU_SI_get(SI_TELE_SETTINGS_AUTO_REFRESH_FREQ),
              tooltip = BMU_SI_get(SI_TELE_SETTINGS_AUTO_REFRESH_FREQ_TOOLTIP) .. " [DEFAULT: " .. BMU_DefaultsAccount["autoRefreshFreq"] .. "]",
              min = 0,
              max = 15,
		 ...
		 {
              type = LHAS.ST_CHECKBOX,
              label = BMU_SI_get(SI_TELE_SETTINGS_SHOW_ZONES_WITHOUT_PLAYERS),
              tooltip = BMU_SI_get(SI_TELE_SETTINGS_SHOW_ZONES_WITHOUT_PLAYERS_TOOLTIP) .. " [DEFAULT: " .. tostring(BMU_DefaultsAccount["showZonesWithoutPlayers2"]) .. "]",
			           ...
			           },
     {
				...
				},
		 {
              ...
              tooltip = BMU_SI_get(SI_TELE_SETTINGS_ONLY_MAPS_TOOLTIP) .. " [DEFAULT: " .. tostring(BMU_DefaultsAccount["onlyMaps"]) .. "]",
		 ...
		 {
              type = LHAS.ST_CHECKBOX,
              label = BMU_SI_get(SI_TELE_SETTINGS_HIDE_OTHERS),
              tooltip = BMU_SI_get(SI_TELE_SETTINGS_HIDE_OTHERS_TOOLTIP) .. " [DEFAULT: " .. tostring(BMU_DefaultsAccount["hideOthers"]) .. "]",
		 ...
		 {
              type = LHAS.ST_CHECKBOX,
              label = BMU_SI_get(SI_TELE_SETTINGS_HIDE_PVP),
              tooltip = BMU_SI_get(SI_TELE_SETTINGS_HIDE_PVP_TOOLTIP) .. " [DEFAULT: " .. tostring(BMU_DefaultsAccount["hidePVP"]) .. "]",
		 ...
		 {
              type = LHAS.ST_CHECKBOX,
              label = BMU_SI_get(SI_TELE_SETTINGS_HIDE_CLOSED_DUNGEONS),
              tooltip = BMU_SI_get(SI_TELE_SETTINGS_HIDE_CLOSED_DUNGEONS_TOOLTIP) .. " [DEFAULT: " .. tostring(BMU_DefaultsAccount["hideClosedDungeons"]) .. "]",
		 ...
		 {
              type = LHAS.ST_CHECKBOX,
              label = BMU_SI_get(SI_TELE_SETTINGS_HIDE_DELVES),
              tooltip = BMU_SI_get(SI_TELE_SETTINGS_HIDE_DELVES_TOOLTIP) .. " [DEFAULT: " .. tostring(BMU_DefaultsAccount["hideDelves"]) .. "]",
		 ...
		 {
              type = LHAS.ST_CHECKBOX,
              label = BMU_SI_get(SI_TELE_SETTINGS_HIDE_PUBLIC_DUNGEONS),
              tooltip = BMU_SI_get(SI_TELE_SETTINGS_HIDE_PUBLIC_DUNGEONS_TOOLTIP) .. " [DEFAULT: " .. tostring(BMU_DefaultsAccount["hidePublicDungeons"]) .. "]",
		 ...
		 {
              type = LHAS.ST_CHECKBOX,
              label = BMU_SI_get(SI_TELE_SETTINGS_HIDE_OWN_HOUSES),
              tooltip = BMU_SI_get(SI_TELE_SETTINGS_HIDE_OWN_HOUSES_TOOLTIP) .. " [DEFAULT: " .. tostring(BMU_DefaultsAccount["hideOwnHouses"]) .. "]",
			           ...
			           },
         {
              ...
              getFunction = function() return BMU.dropdownPrioSourceChoices[BMU_savedVarsServ.prioritizationSource[1]] end,
			  setFunction = function(control, itemName, itemData)
				-- swap positions
				local index = BMU_getIndexFromValue(BMU_savedVarsServ.prioritizationSource, itemData.data)
				BMU_savedVarsServ.prioritizationSource[index] = BMU_savedVarsServ.prioritizationSource[1]
				BMU_savedVarsServ.prioritizationSource[1] = itemData.data
			  end,
			  default = BMU.dropdownPrioSourceChoices[BMU.DefaultsServer["prioritizationSource"][1]],
			          },
		{
              type = LHAS.ST_DROPDOWN,
			  label = "PRIO 2",
              tooltip = "",
			  items = dropdownPrioSourceItems,
              getFunction = function() return BMU.dropdownPrioSourceChoices[BMU_savedVarsServ.prioritizationSource[2]] end,
			  setFunction = function(control, itemName, itemData)
				-- swap positions
				local index = BMU_getIndexFromValue(BMU_savedVarsServ.prioritizationSource, itemData.data)
				BMU_savedVarsServ.prioritizationSource[index] = BMU_savedVarsServ.prioritizationSource[2]
				BMU_savedVarsServ.prioritizationSource[2] = itemData.data
			  end,
			  disabled = function()
			  ...
			  default = BMU.dropdownPrioSourceChoices[BMU.DefaultsServer["prioritizationSource"][2]],
			          },
		{
              type = LHAS.ST_DROPDOWN,
			  label = "PRIO 3",
              tooltip = "",
			  items = dropdownPrioSourceItems,
              getFunction = function() return BMU.dropdownPrioSourceChoices[BMU_savedVarsServ.prioritizationSource[3]] end,
			  setFunction = function(control, itemName, itemData)
			  	-- swap positions
				local index = BMU_getIndexFromValue(BMU_savedVarsServ.prioritizationSource, itemData.data)
				BMU_savedVarsServ.prioritizationSource[index] = BMU_savedVarsServ.prioritizationSource[3]
				BMU_savedVarsServ.prioritizationSource[3] = itemData.data
			  end,
			  disabled = function()
			  ...
			  default = BMU.dropdownPrioSourceChoices[BMU.DefaultsServer["prioritizationSource"][3]],
			          },
		{
              type = LHAS.ST_DROPDOWN,
			  label = "PRIO 4",
              tooltip = "",
			  items = dropdownPrioSourceItems,
              getFunction = function() return BMU.dropdownPrioSourceChoices[BMU_savedVarsServ.prioritizationSource[4]] end,
			  setFunction = function(control, itemName, itemData)
				-- swap positions
				local index = BMU_getIndexFromValue(BMU_savedVarsServ.prioritizationSource, itemData.data)
				BMU_savedVarsServ.prioritizationSource[index] = BMU_savedVarsServ.prioritizationSource[4]
				BMU_savedVarsServ.prioritizationSource[4] = itemData.data
			  end,
			  disabled = function()
			  ...
			  default = BMU.dropdownPrioSourceChoices[BMU.DefaultsServer["prioritizationSource"][4]],
			          },
		{
              type = LHAS.ST_DROPDOWN,
			  label = "PRIO 5",
              tooltip = "",
			  items = dropdownPrioSourceItems,
              getFunction = function() return BMU.dropdownPrioSourceChoices[BMU_savedVarsServ.prioritizationSource[5]] end,
			  setFunction = function(control, itemName, itemData)
			  			  	-- swap positions
				local index = BMU_getIndexFromValue(BMU_savedVarsServ.prioritizationSource, itemData.data)
				BMU_savedVarsServ.prioritizationSource[index] = BMU_savedVarsServ.prioritizationSource[5]
				BMU_savedVarsServ.prioritizationSource[5] = itemData.data
			  end,
			  disabled = function()
			  ...
			  default = BMU.dropdownPrioSourceChoices[BMU.DefaultsServer["prioritizationSource"][5]],
			          },
		{
              type = LHAS.ST_DROPDOWN,
			  label = "PRIO 6",
              tooltip = "",
			  items = dropdownPrioSourceItems,
              getFunction = function() return BMU.dropdownPrioSourceChoices[BMU_savedVarsServ.prioritizationSource[6]] end,
			  setFunction = function(control, itemName, itemData)
			  	-- swap positions
				local index = BMU_getIndexFromValue(BMU_savedVarsServ.prioritizationSource, itemData.data)
				BMU_savedVarsServ.prioritizationSource[index] = BMU_savedVarsServ.prioritizationSource[6]
				BMU_savedVarsServ.prioritizationSource[6] = itemData.data
			  end,
			  disabled = function()
			  ...
			  default = BMU.dropdownPrioSourceChoices[BMU.DefaultsServer["prioritizationSource"][6]],
			          },
		 {
              type = LHAS.ST_CHECKBOX,
              label = BMU_SI_get(SI_TELE_SETTINGS_SHOW_TELEPORT_ANIMATION),
              tooltip = BMU_SI_get(SI_TELE_SETTINGS_SHOW_TELEPORT_ANIMATION_TOOLTIP) .. " [DEFAULT: " .. tostring(BMU_DefaultsAccount["showTeleportAnimation"]) .. "]",
		 ...
		 {
              type = LHAS.ST_CHECKBOX,
              label = BMU_SI_get(SI_TELE_SETTINGS_USE_RALLY_POINT),
              tooltip = BMU_SI_get(SI_TELE_SETTINGS_USE_RALLY_POINT_TOOLTIP) .. " [DEFAULT: " .. tostring(BMU_DefaultsAccount["useMapPing"]) .. "]",
         ...
         {
              type = LHAS.ST_DROPDOWN,
              label = BMU_SI_get(SI_TELE_SETTINGS_SECOND_SEARCH_LANGUAGE),
              tooltip = BMU_SI_get(SI_TELE_SETTINGS_SECOND_SEARCH_LANGUAGE_TOOLTIP) .. " [DEFAULT: " .. BMU.dropdownSecLangChoices[BMU_DefaultsAccount["secondLanguage"]] .. "]",
			  items = dropdownSecLangItems,
              getFunction = function() return BMU.dropdownSecLangChoices[BMU_savedVarsAcc.secondLanguage] end,
		 ...
		 {
              type = LHAS.ST_CHECKBOX,
              label = BMU_SI_get(SI_TELE_SETTINGS_SURVEY_MAP_NOTIFICATION),
              tooltip = BMU_SI_get(SI_TELE_SETTINGS_SURVEY_MAP_NOTIFICATION_TOOLTIP) .. " [DEFAULT: " .. tostring(BMU_DefaultsAccount["surveyMapsNotification"]) .. "]",
		 ...
		 {
              type = LHAS.ST_CHECKBOX,
              label = BMU_SI_get(SI_TELE_SETTINGS_SURVEY_MAP_NOTIFICATION_SOUND),
              tooltip = BMU_SI_get(SI_TELE_SETTINGS_SURVEY_MAP_NOTIFICATION_SOUND_TOOLTIP) .. " [DEFAULT: " .. tostring(BMU_DefaultsAccount["surveyMapsNotificationSound"]) .. "]",
		 ...
		 {
			  type = LHAS.ST_CHECKBOX,
			  label = BMU_SI_get(SI_TELE_SETTINGS_OUTPUT_FAST_TRAVEL),
			  tooltip = BMU_SI_get(SI_TELE_SETTINGS_OUTPUT_FAST_TRAVEL_TOOLTIP) .. " [DEFAULT: " .. tostring(BMU_DefaultsAccount["chatOutputFastTravel"]) .. "]",
	     ...
	     {
			  type = LHAS.ST_CHECKBOX,
			  label = BMU_SI_get(SI_TELE_SETTINGS_OUTPUT_ADDITIONAL),
			  tooltip = BMU_SI_get(SI_TELE_SETTINGS_OUTPUT_ADDITIONAL_TOOLTIP) .. " [DEFAULT: " .. tostring(BMU_DefaultsAccount["chatOutputAdditional"]) .. "]",
   		 ...
   		 {
			  type = LHAS.ST_CHECKBOX,
			  label = BMU_SI_get(SI_TELE_SETTINGS_OUTPUT_UNLOCK),
		 	  tooltip = BMU_SI_get(SI_TELE_SETTINGS_OUTPUT_UNLOCK_TOOLTIP) .. " [DEFAULT: " .. tostring(BMU_DefaultsAccount["chatOutputUnlock"]) .. "]",
		 ...
		 {
			  type = LHAS.ST_CHECKBOX,
			  label = BMU_SI_get(SI_TELE_SETTINGS_OUTPUT_DEBUG),
		 ...
		 {
              type = LHAS.ST_BUTTON,
              label = BMU_colorizeText(BMU_SI_get(SI_TELE_SETTINGS_RESET_ALL_COUNTERS), "red"),
