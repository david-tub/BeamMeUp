...
BMU.textures = {
	...
	dungeonDifficultyNormalStr  = "|t32:32:esoui/art/lfg/lfg_normaldungeon_up.dds|t",
	dungeonDifficultyVeteranStr = "|t32:32:esoui/art/lfg/lfg_veterandungeon_up.dds|t",
...
BMU.blacklistGroupDungeons = {380, 935, 126, 931, 176, 681, 1055, 131, 1052, 31, 22, 38, 1009, 144, 936, 130, 932, 1010, 146, 933, 63, 930, 449, 64, 148, 848, 843, 283, 934, 11, 973, 974, 688, 678, 1080, 1081, 1122, 1123, 1152, 1153, 1201, 1197, 1228, 1229, 1267, 1268, 1301, 1302, 1360, 1361, 1389, 1390, 1470, 1471, 1496, 1497, 1551, 1552}

-- 12 men Raids (Trials) -- order -> http://en.uesp.net/wiki/Online:Trials
BMU.blacklistRaids = {1000, 638, 636, 639, 725, 1051, 975, 1121, 1196, 1263, 1344, 1427, 1478, 1548}
...
BMU.overlandDelvesPublicDungeons = {
	...
	-- Solstice
  	[1502] = {
    	delves = {1511, 1512, 1513, 1527, 1528, 1529},
    	publicDungeons = {1514, 1530, 1553},
		publicDungeonsAchievements = {
