...
local function SetupOptionsMenu(addonName) --index == Addon name                        --CHG251229 Baertram renamed because index is also used in the loop at line 78 and within several setFunc/getFunc of some entries below and the variable is shadowed then
    ...
    local optionsData = {
         ...
         },
         {
              ...
              tooltip = BMU_SI_get(SI.TELE_SETTINGS_SHOW_ON_MAP_OPEN_TOOLTIP) .. " [DEFAULT: " .. tos(BMU_DefaultsPerAccount["ShowOnMapOpen"]) .. "]",
         ...
         },
         {
              ...
              tooltip = BMU_SI_get(SI.TELE_SETTINGS_HIDE_ON_MAP_CLOSE_TOOLTIP) .. " [DEFAULT: " .. tos(BMU_DefaultsPerAccount["HideOnMapClose"]) .. "]",
         ...
         },
		 {
              ...
              tooltip = BMU_SI_get(SI.TELE_SETTINGS_CLOSE_ON_PORTING_TOOLTIP) .. " [DEFAULT: " .. tos(BMU_DefaultsPerAccount["closeOnPorting"]) .. "]",
		 ...
		 },
		 {
              ...
              tooltip = BMU_SI_get(SI.TELE_SETTINGS_WINDOW_STAY_TOOLTIP) .. " [DEFAULT: " .. tos(BMU_DefaultsPerAccount["windowStay"]) .. "]",
		 ...
		 },
		 {
              ...
              tooltip = BMU_SI_get(SI.TELE_SETTINGS_FOCUS_ON_MAP_OPEN_TOOLTIP) .. " [DEFAULT: " .. tos(BMU_DefaultsPerAccount["focusZoneSearchOnOpening"]) .. "]",
         ...
         },
		 {
              ...
              tooltip = BMU_SI_get(SI.TELE_SETTINGS_SHOW_BUTTON_ON_MAP_TOOLTIP) .. " [DEFAULT: " .. tos(BMU_DefaultsPerAccount["showOpenButtonOnMap"]) .. "]",
              requiresReload = true,
         ...
         },
		 {
              ...
              tooltip = BMU_SI_get(SI.TELE_SETTINGS_SHOW_CHAT_BUTTON_TOOLTIP) .. " [DEFAULT: " .. tos(BMU_DefaultsPerAccount["chatButton"]) .. "]",
              requiresReload = true,
         ...
         },
		 {
              ...
              tooltip = BMU_SI_get(SI.TELE_SETTINGS_AUTO_REFRESH_TOOLTIP) .. " [DEFAULT: " .. tos(BMU_DefaultsPerAccount["autoRefresh"]) .. "]",
        ...
        },
		{
		 ...
		 },
         {
              ...
              tooltip = BMU_SI_get(SI.TELE_SETTINGS_SHOW_NUMBER_PLAYERS_TOOLTIP) .. " [DEFAULT: " .. tos(BMU_DefaultsPerAccount["showNumberPlayers"]) .. "]",
		 ...
		 },
         {
              ...
              tooltip = BMU_SI_get(SI.TELE_SETTINGS_SEARCH_CHARACTERNAMES_TOOLTIP) .. " [DEFAULT: " .. tos(BMU_DefaultsPerAccount["searchCharacterNames"]) .. "]",
		 ...
		 },
         {
              ...
              tooltip = BMU_SI_get(SI.TELE_SETTINGS_ZONE_ONCE_ONLY_TOOLTIP) .. " [DEFAULT: " .. tos(BMU_DefaultsPerAccount["zoneOnceOnly"]) .. "]",
		 ...
		 },
		 {
              ...
              tooltip = BMU_SI_get(SI.TELE_SETTINGS_CURRENT_ZONE_ALWAYS_TOP_TOOLTIP) .. " [DEFAULT: " .. tos(BMU_DefaultsPerAccount["currentZoneAlwaysTop"]) .. "]",
		 ...
		 },
		 {
              ...
              tooltip = BMU_SI_get(SI.TELE_SETTINGS_VIEWED_ZONE_ALWAYS_TOP_TOOLTIP) .. " [DEFAULT: " .. tos(BMU_DefaultsPerAccount["currentViewedZoneAlwaysTop"]) .. "]",
		 ...
		 },
		 {
              ...
              tooltip = BMU_SI_get(SI.TELE_SETTINGS_FORMAT_ZONE_NAME_TOOLTIP) .. " [DEFAULT: " .. tos(BMU_DefaultsPerAccount["formatZoneName"]) .. "]",
         ...
         },
		 {
              ...
              tooltip = BMU_SI_get(SI.TELE_SETTINGS_SHOW_ZONES_WITHOUT_PLAYERS_TOOLTIP) .. " [DEFAULT: " .. tos(BMU_DefaultsPerAccount["showZonesWithoutPlayers2"]) .. "]",
         ...
         },
		 {
              ...
              tooltip = BMU_SI_get(SI.TELE_SETTINGS_ONLY_MAPS_TOOLTIP) .. " [DEFAULT: " .. tos(BMU_DefaultsPerAccount["onlyMaps"]) .. "]",
         ...
         },
		 {
              ...
              tooltip = BMU_SI_get(SI.TELE_SETTINGS_HIDE_OTHERS_TOOLTIP) .. " [DEFAULT: " .. tos(BMU_DefaultsPerAccount["hideOthers"]) .. "]",
         ...
         },
		 {
              ...
              tooltip = BMU_SI_get(SI.TELE_SETTINGS_HIDE_PVP_TOOLTIP) .. " [DEFAULT: " .. tos(BMU_DefaultsPerAccount["hidePVP"]) .. "]",
         ...
         },
		 {
              ...
              tooltip = BMU_SI_get(SI.TELE_SETTINGS_HIDE_CLOSED_DUNGEONS_TOOLTIP) .. " [DEFAULT: " .. tos(BMU_DefaultsPerAccount["hideClosedDungeons"]) .. "]",
         ...
         },
		 {
              ...
              tooltip = BMU_SI_get(SI.TELE_SETTINGS_HIDE_DELVES_TOOLTIP) .. " [DEFAULT: " .. tos(BMU_DefaultsPerAccount["hideDelves"]) .. "]",
         ...
         },
		 {
              ...
              tooltip = BMU_SI_get(SI.TELE_SETTINGS_HIDE_PUBLIC_DUNGEONS_TOOLTIP) .. " [DEFAULT: " .. tos(BMU_DefaultsPerAccount["hidePublicDungeons"]) .. "]",
         ...
         },
		 {
              ...
              tooltip = BMU_SI_get(SI.TELE_SETTINGS_HIDE_HOUSES_TOOLTIP) .. " [DEFAULT: " .. tos(BMU_DefaultsPerAccount["hideHouses"]) .. "]",
         ...
         },
		 {
              ...
              tooltip = BMU_SI_get(SI.TELE_SETTINGS_HIDE_OWN_HOUSES_TOOLTIP) .. " [DEFAULT: " .. tos(BMU_DefaultsPerAccount["hideOwnHouses"]) .. "]",
        ...
        },
		{
        ...
        },
		 {
              ...
              tooltip = BMU_SI_get(SI.TELE_SETTINGS_SHOW_TELEPORT_ANIMATION_TOOLTIP) .. " [DEFAULT: " .. tos(BMU_DefaultsPerAccount["showTeleportAnimation"]) .. "]",
         ...
         },
		 {
              ...
              tooltip = BMU_SI_get(SI.TELE_SETTINGS_USE_PAN_AND_ZOOM_TOOLTIP) .. " [DEFAULT: " .. tos(BMU_DefaultsPerAccount["usePanAndZoom"]) .. "]",
         ...
         },
		 {
              ...
              tooltip = BMU_SI_get(SI.TELE_SETTINGS_USE_RALLY_POINT_TOOLTIP) .. " [DEFAULT: " .. tos(BMU_DefaultsPerAccount["useMapPing"]) .. "]",
         ...
         },
		 {
              ...
              tooltip = BMU_SI_get(SI.TELE_SETTINGS_NOTIFICATION_PLAYER_FAVORITE_ONLINE_TOOLTIP) .. " [DEFAULT: " .. tos(BMU_DefaultsPerAccount["FavoritePlayerStatusNotification"]) .. "]",
         ...
         },
		 {
              ...
              tooltip = BMU_SI_get(SI.TELE_SETTINGS_SURVEY_MAP_NOTIFICATION_TOOLTIP) .. " [DEFAULT: " .. tos(BMU_DefaultsPerAccount["surveyMapsNotification"]) .. "]",
         ...
         },
		 {
              ...
              tooltip = BMU_SI_get(SI.TELE_SETTINGS_SURVEY_MAP_NOTIFICATION_SOUND_TOOLTIP) .. " [DEFAULT: " .. tos(BMU_DefaultsPerAccount["surveyMapsNotificationSound"]) .. "]",
         ...
         },
		 {
              ...
              tooltip = BMU_SI_get(SI.TELE_SETTINGS_AUTO_CONFIRM_WAYSHRINE_TRAVEL_TOOLTIP) .. " [DEFAULT: " .. tos(BMU_DefaultsPerAccount["wayshrineTravelAutoConfirm"]) .. "]",
         ...
         },
		 {
              ...
              tooltip = BMU_SI_get(SI.TELE_SETTINGS_OFFLINE_NOTE_TOOLTIP) .. " [DEFAULT: " .. tos(BMU_DefaultsPerAccount["showOfflineReminder"]) .. "]",
         ...
         },
		 {
			  ...
			  tooltip = BMU_SI_get(SI.TELE_SETTINGS_OUTPUT_FAST_TRAVEL_TOOLTIP) .. " [DEFAULT: " .. tos(BMU_DefaultsPerAccount["chatOutputFastTravel"]) .. "]",
	     ...
	     },
	     {
			  ...
			  tooltip = BMU_SI_get(SI.TELE_SETTINGS_OUTPUT_ADDITIONAL_TOOLTIP) .. " [DEFAULT: " .. tos(BMU_DefaultsPerAccount["chatOutputAdditional"]) .. "]",
   		 ...
   		 },
   		 {
			  ...
			  name = BMU_SI_get(SI.TELE_SETTINGS_OUTPUT_UNLOCK),
		 	  tooltip = BMU_SI_get(SI.TELE_SETTINGS_OUTPUT_UNLOCK_TOOLTIP) .. " [DEFAULT: " .. tos(BMU_DefaultsPerAccount["chatOutputUnlock"]) .. "]",
