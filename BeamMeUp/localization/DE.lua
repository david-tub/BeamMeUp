...
local strings = {
    ...
    ["SI_TELE_UI_HOUSE_TOURS_FILTER"] = "Heimschau",
    ...
    ["SI_TELE_SETTINGS_DIAGNOSTIC_COMMANDS"] = "Aktiviere Diagnose-Chatbefehle",
    ["SI_TELE_SETTINGS_DIAGNOSTIC_COMMANDS_TOOLTIP"] = "Aktiviert die Diagnose-Chatbefehle unter /bmu/diag und stellt sie über LibSlashCommander zur Autovervollständigung bereit. Änderungen erfordern einen UI-Neustart.",
    ...
    ["SI_TELE_DROPDOWN_SECOND_LANG_CHOICE_8"] = "Spanisch",
    ["SI_TELE_DROPDOWN_SECOND_LANG_CHOICE_9"] = "Chinesisch",
