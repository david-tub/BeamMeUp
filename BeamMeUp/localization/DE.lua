...
local strings = {
    ...
    ["SI_TELE_SETTINGS_PREFER_PERFORMANCE"] = "Verbesserte Leistung bevorzugen",
    ["SI_TELE_SETTINGS_PREFER_PERFORMANCE_TOOLTIP"] = "Die Zonenübersicht der Spieler wird seltener aktualisiert, dafür aber eine bessere Leistung erzielt",
