...
local stringsEN = {
    ...
    ["SI_TELE_SETTINGS_PREFER_PERFORMANCE"] = "Prefer Enhanced Performance",
    ["SI_TELE_SETTINGS_PREFER_PERFORMANCE_TOOLTIP"] = "In exchange for better performance, reduce the freshness and accuracy of the player zone list",
