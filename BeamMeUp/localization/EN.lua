...
local stringsEN = {
    ...
    ["SI_TELE_UI_HOUSE_TOURS_FILTER"] = "House Tours",
    ...
    ["SI_TELE_SETTINGS_DIAGNOSTIC_COMMANDS"] = "Activate diagnostic chat commands",
    ["SI_TELE_SETTINGS_DIAGNOSTIC_COMMANDS_TOOLTIP"] = "Activates diagnostic chat commands under /bmu/diag and makes them available through LibSlashCommander autocomplete. Changes require a UI reload.",
