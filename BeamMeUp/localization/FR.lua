local strings = {
    ...
    -- INTERFACE
    -----------------------------------------------------------------------------
    ["SI_TELE_UI_TOTAL      "] = "Résultats :",
    ["SI_TELE_UI_GOLD       "] = "Or économisé :",
    ["SI_TELE_UI_GOLD_ABBR  "] = "k",
    ["SI_TELE_UI_GOLD_ABBR2 "] = "M",
    ["SI_TELE_UI_TOTAL_PORTS"] = "Total des TP :",
    ---------
    --------- Buttons
    ["SI_TELE_UI_BTN_REFRESH_ALL        "] = "Rafraîchir toutes les zones",
    ["SI_TELE_UI_BTN_UNLOCK_WS          "] = "Déverrouiller les oratoires de la zone",
    ["SI_TELE_UI_BTN_FIX_WINDOW         "] = "Verrouiller / Déverrouiller la fenêtre",
    ["SI_TELE_UI_BTN_TOGGLE_ZONE_GUIDE  "] = "Basculer vers BeamMeUp",
    ["SI_TELE_UI_BTN_TOGGLE_BMU         "] = "Basculer vers le guide de zone",
    ["SI_TELE_UI_BTN_PORT_TO_OWN_HOUSE  "] = "Maisons possédées",
    ["SI_TELE_UI_BTN_ANCHOR_ON_MAP      "] = "Ancrer à la carte / Libérer",
    ["SI_TELE_UI_BTN_GUILD_BMU          "] = "Guildes BeamMeUp & Guildes partenaires",
    ["SI_TELE_UI_BTN_GUILD_HOUSE_BMU    "] = "Visiter la maison de guilde BeamMeUp",
    ["SI_TELE_UI_BTN_PTF_INTEGRATION    "] = "Integration \"Port to Friend's House\"",
    ["SI_TELE_UI_BTN_DUNGEON_FINDER		"] = "Arènes / Épreuves / Donjons",
    ["SI_TELE_UI_BTN_TOOLTIP_CONTEXT_MENU"] = "\n|c777777(clic droit pour plus d'options)",
    ---------
    --------- List
    --["SI_TELE_UI_UNRELATED_ITEMS      "] = "Autres zones",
    ["SI_TELE_UI_UNRELATED_QUESTS     "] = "Quêtes dans d'autres zones",
    ["SI_TELE_UI_SAME_INSTANCE        "] = "Même instance",
    ["SI_TELE_UI_DIFFERENT_INSTANCE   "] = "Instance différente",
    ["SI_TELE_UI_GROUP_EVENT          "] = "Événement de groupe",
    ---------
    --------- Menu
    ["SI_TELE_UI_FAVORITE_PLAYER         "] = "Joueurs favoris",
    ["SI_TELE_UI_FAVORITE_ZONE           "] = "Zones favorites",
    ["SI_TELE_UI_VOTE_TO_LEADER          "] = "Votez pour le chef",
    ["SI_TELE_UI_RESET_COUNTER_ZONE      "] = "Réinitialiser les compteurs",
    ["SI_TELE_UI_INVITE_BMU_GUILD        "] = "Inviter dans la guilde BeamMeUp",
    ["SI_TELE_UI_SHOW_QUEST_MARKER_ON_MAP"] = "Montrer le marqueur de quête",
    ["SI_TELE_UI_RENAME_HOUSE_NICKNAME   "] = "Renommer la maison",
    ["SI_TELE_UI_TOGGLE_HOUSE_NICKNAME   "] = "Montrer les noms personnalisés",
    ["SI_TELE_UI_VIEW_MAP_ITEM           "] = "Montrer la carte",
    ["SI_TELE_UI_TOGGLE_ARENAS			 "] = "Arènes solo",
    ["SI_TELE_UI_TOGGLE_GROUP_ARENAS	 "] = "Arènes de groupe",
    ["SI_TELE_UI_TOGGLE_TRIALS			 "] = "Épreuves",
    ["SI_TELE_UI_TOGGLE_ENDLESS_DUNGEONS "] = "Donjons infinis",
    ["SI_TELE_UI_TOGGLE_GROUP_DUNGEONS	 "] = "Donjons de groupe",
    ["SI_TELE_UI_TOGGLE_SORT_ACRONYM	 "] = "Tri par acronyme",
    ["SI_TELE_UI_DAYS_LEFT				 "] = "%d jours",
    ["SI_TELE_UI_TOGGLE_UPDATE_NAME      "] = "Afficher le nom de la mise à jour",
    ["SI_TELE_UI_UNLOCK_WAYSHRINES		 "] = "Découverte automatique des oratoires",
    ["SI_TELE_UI_TOOGLE_ZONE_NAME		 "] = "Afficher le nom de la zone",
    ["SI_TELE_UI_TOGGLE_SORT_RELEASE     "] = "Trier par édition",
    ...
    -- CHAT OUTPUTS
    -----------------------------------------------------------------------------
    ["SI_TELE_CHAT_FAVORITE_UNSET					"] = "L'emplacement favori est indéfini.",
    ["SI_TELE_CHAT_FAVORITE_PLAYER_NO_FAST_TRAVEL  	"] = "Le joueur est déconnecté ou caché par des filtres.",
    ["SI_TELE_CHAT_NO_FAST_TRAVEL    				"] = "Aucun voyage rapide trouvé",
    ["SI_TELE_CHAT_NOT_IN_GROUP                    	"] = "Vous n'êtes pas dans un groupe.",
    ["SI_TELE_CHAT_PORT_TO_OWN_PRIMARY_HOUSE_FAILED	"] = "Aucune résidence principale définie !",
    ["SI_TELE_CHAT_GROUP_LEADER_YOURSELF			"] = "Vous êtes chef de votre groupe.",
    ["SI_TELE_CHAT_UNLOCK_WS_DISCOVERED_TOTAL		"] = "Nombre d'oratoires découverts dans cette zone :",
    ["SI_TELE_CHAT_UNLOCK_WS_NEED_DISCOVERED		"] = "Vous devez toujours vous rendre sur place pour les oratoires suivants :",
    ...
    ["SI_TELE_SETTINGS_PREFER_PERFORMANCE"] = "Privilégier les performances améliorées",
    ["SI_TELE_SETTINGS_PREFER_PERFORMANCE_TOOLTIP"] = "La liste des zones du joueur se actualisera moins souvent en échange de meilleures performances",
    ...
    -- KEY BINDING
    -----------------------------------------------------------------------------
    ["SI_TELE_KEYBINDING_TOGGLE_MAIN"] = "Ouvrir BeamMeUp",
    ["SI_TELE_KEYBINDING_TOGGLE_MAIN_RELATED_ITEMS"] = "Cartes au trésor, Repérages & Pistes",
    ["SI_TELE_KEYBINDING_REFRESH"] = "Actualiser",
    ["SI_TELE_KEYBINDING_WAYSHRINE_UNLOCK"] = "Déblocage des oratoires",
    ["SI_TELE_KEYBINDING_PRIMARY_RESIDENCE"] = "Se téléporter à l'intérieur de la résidence principale",
    ["SI_TELE_KEYBINDING_GUILD_HOUSE_BMU"] = "Visiter la maison de guilde BeamMeUp",
    ["SI_TELE_KEYBINDING_CURRENT_ZONE"] = "Voyage dans la zone actuelle",
    ["SI_TELE_KEYBINDING_PRIMARY_RESIDENCE_OUTSIDE"] = "Se téléporter à l'extérieur de la résidence principale",
    ["SI_TELE_KEYBINDING_TOGGLE_MAIN_DUNGEON_FINDER"] = "Arènes / Épreuves / Donjons",
    ["SI_TELE_KEYBINDING_TRACKED_QUEST"] = "Voyage vers la quête courante",
    ["SI_TELE_KEYBINDING_ANY_ZONE"] = "Téléportation vers zone aléatoire",
    ...
    -----------------------------------------------------------------------------
    ["SI_TELE_DIALOG_NO_BMU_GUILD_BODY"] = "Nous sommes désolés, mais il semblerait qu'il n'y a pas encore de guilde BeamMeUp active sur ce serveur.\n\nN'hésitez pas à nous contacter via le site ESOUI afin qu'une guilde officielle BeamMeUp soit créée sur ce serveur.",
    ["SI_TELE_DIALOG_INFO_BMU_GUILD_BODY"] = "Bonjour et merci d'utiliser BeamMeUp. En 2019, nous avons créé plusieurs guildes BeamMeUp dans le but de partager librement nos options de voyage rapide. Toutle monde est bienvenu, aucun prérequis ni obligation !\n\nEn confirmant cette boîte de dialogue, vous verrez les guildes officielles BeamMeUp et les guildes partenaires. Nous vous invitons cordialement à nous rejoindre ! Vous pouvez aussi afficher les guildes en cliquant sur le bouton guilde dans le coin en haut à gauche.\nVotre équipe BeamMeUp",
    ["SI_TELE_DIALOG_INFO_NEW_FEATURE_FAVORITE_PLAYER_NOTIFICATION"] = "Vous recevez une notification (message au centre de l'écran) quand un joueur favori se connecte.\n\nActiver cette fonctionnalité ?",
    ["SI_TELE_DIALOG_INFO_NEW_FEATURE_SURVEY_MAP_NOTIFICATION"] = "Si vous récoltez un repérage et qu'il reste encore des cartes identiques (même endroit) dans votre inventaire, une notification (message au centre de l'écran) vous en avertira.\n\nActiver cette fonctionnalité ?",
    ["SI_TELE_DIALOG_PTF_INTEGRATION_MISSING_TITLE"] = "Integration de \"Port to Friend's House\"",
    ["SI_TELE_DIALOG_PTF_INTEGRATION_MISSING_BODY"] = "Pour utiliser la fonctionnalité d'intégration, installez l'extension \"Port to Friend's House\". Vos maisons et manoirs de guilde configurés apparaitront alors dans cette liste.\n\nVoulez-vous accéder au site de l'extension ?",
    ...
    ["SI_TELE_DIALOG_AUTO_UNLOCK_ORDER_OPTION4"] = "par nom de zone",
    ["SI_TELE_DIALOG_AUTO_UNLOCK_CHAT_LOG_OPTION"] = "Résultats dans le tchat",
    -- AUTO UNLOCK: Refuse Dialogs
    ["SI_TELE_DIALOG_REFUSE_AUTO_UNLOCK_TITLE"] = "La découverte n'est pas possible",
    ["SI_TELE_DIALOG_REFUSE_AUTO_UNLOCK_BODY"] = "Tous les oratoires de la zone ont été découverts.",
    ["SI_TELE_DIALOG_REFUSE_AUTO_UNLOCK_BODY2"] = "La découverte des oratoires n'est pas disponible dans cette zone. Cette fonctionnalité n'est disponible que dans les zones et régions principales.",
    ["SI_TELE_DIALOG_REFUSE_AUTO_UNLOCK_BODY3"] = "Malheureusement, il n'y a pas de joueurs dans la zone vers lequel voyager.",
    -- AUTO UNLOCK: Process Dialog
    ["SI_TELE_DIALOG_PROCESS_AUTO_UNLOCK_BODY_PART"] = "Découverte automatique des oratoires en cours...",
    ["SI_TELE_DIALOG_PROCESS_AUTO_UNLOCK_BODY_PART_DISCOVERY"] = "Nouveaux oratoires découverts :",
    ["SI_TELE_DIALOG_PROCESS_AUTO_UNLOCK_BODY_PART_XP"] = "XP gagnés :",
    ["SI_TELE_DIALOG_PROCESS_AUTO_UNLOCK_BODY_PART_PROGRESS"] = "Avancement :",
    ["SI_TELE_DIALOG_PROCESS_AUTO_UNLOCK_BODY_PART_TIMER"] = "Prochain saut dans :",
    -- AUTO UNLOCK: Finish Dialog
    ["SI_TELE_DIALOG_FINISH_AUTO_UNLOCK_BODY_PART"] = "Découverte automatique des oratoires terminé.",
    -- AUTO UNLOCK: Timeout Dialog
    ["SI_TELE_DIALOG_TIMEOUT_AUTO_UNLOCK_TITLE"] = "Temps dépassé",
    ["SI_TELE_DIALOG_TIMEOUT_AUTO_UNLOCK_BODY"] = "Désolé - une erreur inconnue est survenue. La découverte automatique a été annulée.",
    -- AUTO UNLOCK: Loop Finish Dialog
    ["SI_TELE_DIALOG_LOOP_FINISH_AUTO_UNLOCK_TITLE"] = "Découverte automatique terminée",
    ["SI_TELE_DIALOG_LOOP_FINISH_AUTO_UNLOCK_BODY"] = "Pas d'autres zones à découvrir. Soit il n'y a plus de joueurs dans les zones, ou vous avez déjà découvert tous les oratoires.",
    ...
    -----------------------------------------------------------------------------
    ["SI_TELE_CENTERSCREEN_OFFLINE_NOTE_HEAD"] = "Vous êtes encore en mode hors-ligne !",
    ["SI_TELE_CENTERSCREEN_OFFLINE_NOTE_BODY"] = "Personne ne peut chuchoter ou voyager vers vous !\n|c8c8c8c(Notification suppressible dans les options de BeamMeUp)",
    ["SI_TELE_CENTERSCREEN_SURVEY_MAPS"] = "Il vous reste %d de ces repérages. Revenez après régénération !",
    ["SI_TELE_CENTERSCREEN_FAVORITE_PLAYER_ONLINE"] = "est maintenant en ligne !",
    ...
    -----------------------------------------------------------------------------
    ["SI_CONSTANT_TREASURE_MAP"] = "carte au trésor", -- need a part of the item name that is in every treasure map item the same no matter which zone
    ["SI_CONSTANT_SURVEY_MAP"] = "repérages", -- need a part of the item name that is in every survey map item the same no matter which zone and kind of craft
