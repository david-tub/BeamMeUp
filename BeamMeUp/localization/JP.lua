...
mkstr(SI.TELE_UI_GROUP_EVENT, "グループイベント")
---------
--------- Menu
...
mkstr(SI.TELE_UI_SHOW_QUEST_MARKER_ON_MAP, "クエストマーカーを表示")
...
mkstr(SI.TELE_UI_TOGGLE_ENDLESS_DUNGEONS, "エンドレスダンジョン")
...
mkstr(SI.TELE_UI_TOGGLE_UPDATE_NAME, "アップデート名を表示")
mkstr(SI.TELE_UI_UNLOCK_WAYSHRINES, "旅の祠の自動解除")
mkstr(SI.TELE_UI_TOOGLE_ZONE_NAME, "ゾーン名を表示")
...
mkstr(SI.TELE_DIALOG_AUTO_UNLOCK_ORDER_OPTION4, "ゾーン名順")
