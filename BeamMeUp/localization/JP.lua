local strings = {
    ...
    -- INTERFACE
    -----------------------------------------------------------------------------
    ["SI_TELE_UI_TOTAL"] = "ポート先件数:",
    ["SI_TELE_UI_GOLD"] = "BMUで節約したGold:",
    ["SI_TELE_UI_GOLD_ABBR"] = "k",
    ["SI_TELE_UI_GOLD_ABBR2"] = "m",
    ["SI_TELE_UI_TOTAL_PORTS"] = "総移動回数:",
    ---------
    --------- Buttons
    ["SI_TELE_UI_BTN_REFRESH_ALL"] = "プレイヤー一覧を更新する",
    ["SI_TELE_UI_BTN_UNLOCK_WS"] = "現在のゾーンの旅の祠を解除",
    ["SI_TELE_UI_BTN_FIX_WINDOW"] = "ウィンドウを固定／固定を解除する",
    ["SI_TELE_UI_BTN_TOGGLE_ZONE_GUIDE"] = "BeamMeUpに切り替える",
    ["SI_TELE_UI_BTN_TOGGLE_BMU"] = "ゾーンガイドに切り替える",
    ["SI_TELE_UI_BTN_PORT_TO_OWN_HOUSE"] = "購入済み住居",
    ["SI_TELE_UI_BTN_ANCHOR_ON_MAP"] = "マップに固定／固定解除する",
    ["SI_TELE_UI_BTN_GUILD_BMU"] = "BeamMeUp公式ギルド＆パートナーギルド",
    ["SI_TELE_UI_BTN_GUILD_HOUSE_BMU"] = "BeamMeUp公式ギルドのギルドハウスを訪ねる",
    ["SI_TELE_UI_BTN_PTF_INTEGRATION"] = "\"Port to Friend's House\" との連携\n（お気に入りリスト）",
    ["SI_TELE_UI_BTN_DUNGEON_FINDER"] = "アリーナ / 試練 / ダンジョン",
    ...
    ["SI_TELE_UI_GROUP_EVENT"] = "グループイベント",
    ---------
    --------- Menu
    ["SI_TELE_UI_FAVORITE_PLAYER"] = "プレイヤーのお気に入り",
    ["SI_TELE_UI_FAVORITE_ZONE"] = "ゾーンのお気に入り",
    ["SI_TELE_UI_VOTE_TO_LEADER"] = "リーダーに投票する",
    ["SI_TELE_UI_RESET_COUNTER_ZONE"] = "カウンターをリセット",
    ["SI_TELE_UI_INVITE_BMU_GUILD"] = "BeamMeUp公式ギルドに招待する",
    ["SI_TELE_UI_SHOW_QUEST_MARKER_ON_MAP"] = "クエストマーカーを表示",
    ["SI_TELE_UI_RENAME_HOUSE_NICKNAME"] = "家のニックネームを変更する",
    ["SI_TELE_UI_TOGGLE_HOUSE_NICKNAME"] = "ニックネームを表示する",
    ["SI_TELE_UI_VIEW_MAP_ITEM"] = "地図を表示",
    ["SI_TELE_UI_TOGGLE_ARENAS"] = "ソロアリーナ",
    ["SI_TELE_UI_TOGGLE_GROUP_ARENAS"] = "グループアリーナ",
    ["SI_TELE_UI_TOGGLE_TRIALS"] = "試練",
    ["SI_TELE_UI_TOGGLE_ENDLESS_DUNGEONS"] = "エンドレスダンジョン",
    ["SI_TELE_UI_TOGGLE_GROUP_DUNGEONS"] = "グループダンジョン",
    ["SI_TELE_UI_TOGGLE_SORT_ACRONYM"] = "頭文字で並び替え",
    ["SI_TELE_UI_DAYS_LEFT"] = "残り日数 %d",
    ["SI_TELE_UI_TOGGLE_UPDATE_NAME"] = "アップデート名を表示",
    ["SI_TELE_UI_UNLOCK_WAYSHRINES"] = "旅の祠の自動解除",
    ["SI_TELE_UI_TOOGLE_ZONE_NAME"] = "ゾーン名を表示",
    ["SI_TELE_UI_TOGGLE_SORT_RELEASE"] = "リリース順に並べ替え",
    ...
    -- CHAT OUTPUTS
    -----------------------------------------------------------------------------
    ["SI_TELE_CHAT_FAVORITE_UNSET"] = "お気に入りのスロットが設定されていません",
    ["SI_TELE_CHAT_FAVORITE_PLAYER_NO_FAST_TRAVEL"] = "プレイヤーがオフラインかフィルタ設定されています",
    ["SI_TELE_CHAT_NO_FAST_TRAVEL"] = "ファストトラベルのオプションが見つかりません",
    ["SI_TELE_CHAT_NOT_IN_GROUP"] = "グループに所属していません",
    ["SI_TELE_CHAT_PORT_TO_OWN_PRIMARY_HOUSE_FAILED"] = "本邸が設定されていません！",
    ["SI_TELE_CHAT_GROUP_LEADER_YOURSELF"] = "貴方がグループリーダーです",
    ["SI_TELE_CHAT_UNLOCK_WS_DISCOVERED_TOTAL"] = "ゾーンで発見した旅の祠の総計:",
    ["SI_TELE_CHAT_UNLOCK_WS_NEED_DISCOVERED"] = "以下の旅の祠はまず直接訪れる必要があります:",
    ...
    ["SI_TELE_SETTINGS_PREFER_PERFORMANCE"] = "パフォーマンス強化を優先",
    ["SI_TELE_SETTINGS_PREFER_PERFORMANCE_TOOLTIP"] = "パフォーマンスを向上させる代わりに、プレイヤーゾーンリストの更新頻度が下がります",
    ...
    -----------------------------------------------------------------------------
    ["SI_TELE_DIALOG_NO_BMU_GUILD_BODY"] = "申し訳ありません。こちらのメガサーバーにはBeamMeUp公式ギルドがまだ存在しておりません。\n\nこのサーバーでBeamMeUpの公式ギルドを作成するのでしたら、ESOUIのサイトからお気軽にご連絡下さい。",
    ["SI_TELE_DIALOG_INFO_BMU_GUILD_BODY"] = "BeamMeUpをご利用いただき、ありがとうございます。より多くのファストトラベル先を共有するために、2019年よりBeamMeUp公式ギルドの運営を開始致しました。どなたでも入隊を歓迎します。入隊要件、義務はありません。\n\nこちらの確認後に、BeamMeUp公式ギルド＆パートナーギルドの一覧を表示します。入隊を歓迎します！ ギルド画面左上のプルダウンボタンからもギルド検索を行えます。 \nBeamMeUp開発チーム一同",
    ["SI_TELE_DIALOG_INFO_NEW_FEATURE_FAVORITE_PLAYER_NOTIFICATION"] = "お気に入りのプレイヤーがオンラインになりましたら通知（画面中央）を受け取ります。\n\nこの機能を有効にしますか？",
    ["SI_TELE_DIALOG_INFO_NEW_FEATURE_SURVEY_MAP_NOTIFICATION"] = "調査の地図の収穫完了時、インベントリに同じ地図がまだ残っていたら通知を表示します。 (画面中央のメッセージ)\n\nこの機能を有効にしますか？",
    ["SI_TELE_DIALOG_PTF_INTEGRATION_MISSING_TITLE"] = "\"Port to Friend's House\"との連携",
    ["SI_TELE_DIALOG_PTF_INTEGRATION_MISSING_BODY"] = "この連携機能を使用するには、アドオン「\"Port to Friend's House\"」のインストールが必要です。アドオンのインストールとお気に入りの設定後に、それらのハウスやギルドホールがこちらに表示されます。\n\n 「\"Port to Friend's House\"」のウェブサイトをブラウザで開きますか？",
    ...
    ["SI_TELE_DIALOG_AUTO_UNLOCK_ORDER_OPTION4"] = "ゾーン名順",
    ["SI_TELE_DIALOG_AUTO_UNLOCK_CHAT_LOG_OPTION"] = "チャットで結果を出力",
    -- AUTO UNLOCK: Refuse Dialogs
    ["SI_TELE_DIALOG_REFUSE_AUTO_UNLOCK_TITLE"] = "現在、旅の祠の解除は実行できません。",
    ["SI_TELE_DIALOG_REFUSE_AUTO_UNLOCK_BODY"] = "このゾーンの旅の祠は全て解除されました。",
    ["SI_TELE_DIALOG_REFUSE_AUTO_UNLOCK_BODY2"] = "このゾーンでは旅の祠の解除は実行できません。オーバーランド／リージョンでのみ実行できます。",
    ["SI_TELE_DIALOG_REFUSE_AUTO_UNLOCK_BODY3"] = "残念ながら、このゾーンには移動に利用可能なプレイヤーがいません。",
    -- AUTO UNLOCK: Process Dialog
    ["SI_TELE_DIALOG_PROCESS_AUTO_UNLOCK_BODY_PART"] = "旅の祠を自動検出中…",
    ["SI_TELE_DIALOG_PROCESS_AUTO_UNLOCK_BODY_PART_DISCOVERY"] = "新たに発見された旅の祠:",
    ["SI_TELE_DIALOG_PROCESS_AUTO_UNLOCK_BODY_PART_XP"] = "獲得したXP:",
    ["SI_TELE_DIALOG_PROCESS_AUTO_UNLOCK_BODY_PART_PROGRESS"] = "進行状況:",
    ["SI_TELE_DIALOG_PROCESS_AUTO_UNLOCK_BODY_PART_TIMER"] = "次のジャンプ:",
    -- AUTO UNLOCK: Finish Dialog
    ["SI_TELE_DIALOG_FINISH_AUTO_UNLOCK_BODY_PART"] = "旅の祠の自動検出が完了しました。",
    -- AUTO UNLOCK: Timeout Dialog
    ["SI_TELE_DIALOG_TIMEOUT_AUTO_UNLOCK_TITLE"] = "タイムアウト",
    ["SI_TELE_DIALOG_TIMEOUT_AUTO_UNLOCK_BODY"] = "申し訳ありませんが、不明なエラーが発生しました。自動検出はキャンセルされました。",
    -- AUTO UNLOCK: Loop Finish Dialog
    ["SI_TELE_DIALOG_LOOP_FINISH_AUTO_UNLOCK_TITLE"] = "自動検出が終了しました",
    ["SI_TELE_DIALOG_LOOP_FINISH_AUTO_UNLOCK_BODY"] = "もう発見すべきゾーンはありません。ゾーンにプレイヤーがいないか、すでに全ての旅の祠を発見してしまったかのいずれかです。",
    ...
    -----------------------------------------------------------------------------
    ["SI_TELE_CENTERSCREEN_OFFLINE_NOTE_HEAD"] = "注意：あなたはまだオフラインに設定されています！",
    ["SI_TELE_CENTERSCREEN_OFFLINE_NOTE_BODY"] = "誰もあなたにささやいたり移動したりできません！\n|c8c8c8c(通知はBeamMeUpの設定で無効にできます)",
    ["SI_TELE_CENTERSCREEN_SURVEY_MAPS"] = "%d 枚の調査報告が残っています！ リスポーン後に戻ってきてください！",
    ["SI_TELE_CENTERSCREEN_FAVORITE_PLAYER_ONLINE"] = "がオンラインになりました！",
    ...
    -----------------------------------------------------------------------------
    ["SI_CONSTANT_TREASURE_MAP"] = "宝箱の地図", -- need a part of the item name that is in every treasure map item the same no matter which zone
    ["SI_CONSTANT_SURVEY_MAP"] = "調査:", -- need a part of the item name that is in every survey map item the same no matter which zone and kind of craft
