local strings = {
    ...
    ["SI_TELE_SETTINGS_PREFER_PERFORMANCE"] = "Предпочитать улучшенную производительность",
    ["SI_TELE_SETTINGS_PREFER_PERFORMANCE_TOOLTIP"] = "Список зон игрока будет обновляться реже в обмен на повышенную производительность",
